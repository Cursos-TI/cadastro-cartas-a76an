...
int main() {
  // Área para definição das variáveis para armazenar as propriedades das cidades
    ...
    float area, pib, densidadePopulacional, pibPerCapita, area2, pib2, densidadePopulacional2, pibPerCapita2;
  ...
  pibPerCapita = (float) pib * 1000000/populacao;
    
  densidadePopulacional2 = (float) populacao2/area2;
  pibPerCapita2 = (float) pib2 * 1000000/populacao2;
  ...
  printf("\n*********************************************\n");
    ...
    printf("Carta 2:\nEstado: %c\nCódigo: %s\nNome da Cidade: %s\nPopulação: %d\nÁrea: %.2f km²\nPIB: %.2f bilhões de reais\n"
      "Número de Pontos Turísticos: %d\nDensidade Populacional: %.2f hab/km²\nPIB per Capita: %.2f reais\n", 
      estado2, codigoCarta2, cidade2, populacao2, area2, pib2, pontosTuristicos2, densidadePopulacional2, pibPerCapita2);
